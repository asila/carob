...
## download and read data 
	...
	env <- ff[basename(ff) == "11TH HTWYT_EnvData.xls"]
	geno <- ff[basename(ff) == "11TH HTWYT_Genotypes_Data.xls"]
	grn <- ff[basename(ff) == "11TH HTWYT_GrnYld.xls"]
	loc <- ff[basename(ff) == "11TH HTWYT_Loc_data.xls"]
	raw <- ff[basename(ff) == "11TH HTWYT_RawData.xls"]
...
# other variables
	...
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "SOYABEAN", "soybean", renv$USE_OF_FIELD_SPECIFY_CROP)
	...
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "PEAS", "chickpea", renv$USE_OF_FIELD_SPECIFY_CROP)
	renv$USE_OF_FIELD_SPECIFY_CROP <- ifelse(renv$USE_OF_FIELD_SPECIFY_CROP == "PEAS", "chickpea", renv$USE_OF_FIELD_SPECIFY_CROP)
